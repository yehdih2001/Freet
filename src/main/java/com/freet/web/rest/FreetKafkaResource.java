...
@RestController
@RequestMapping("/api/freet-kafka")
public class FreetKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FreetKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FreetKafkaResource(KafkaProperties kafkaProperties) {
